...
<%@ page import="com.htsoft.est.model.system.GlobalType,com.htsoft.est.service.system.GlobalTypeService" %>
<%@ page import="com.htsoft.est.model.flow.ProDefinition,com.htsoft.est.service.flow.ProDefinitionService" %>
<%@ page import="com.htsoft.core.jbpm.jpdl.JpdlConverter" %>
<%@ page import="org.dom4j.Element" %>
<%@ page import="com.htsoft.est.service.bpm.ILog.factory.BpmFactory" %>
<%
