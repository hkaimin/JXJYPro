/**
 * @author:
 * @class JxjyXfshWstView
 * @extends Ext.Panel
 * @description [JxjyRyxfgl]管理
 * @company 广州宏天软件有限公司
 * @createtime:
 */
JxjyXfshWstView = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		JxjyXfshWstView.superclass.constructor.call(this, {
			id : 'JxjyXfshWstView',
			title : '学分审核',
			region : 'center',
			layout : 'border',
...
//				} 
	...
	xfCommit : function() {
		...
		var grid = Ext.getCmp("JxjyWSTRyxfglGrid");
