			...
			if("decision".equals(el.getName())){
				...
				if(name.equals(activityName)){
					...
					if(handlerEl==null){
						...
						handlerEl.addAttribute("class", "com.htsoft.est.workflow.handler.DecisionHandlerImpl");
					}
					break;
				}
			}
			...
			if("decision".equals(handleType)){//decsion的handler加入
				...
				if(name.equals(activityName)){
					...
					if(!isStartEventExist){
						...
						listEl.addAttribute("class", "com.htsoft.est.workflow.event.NodeEventListener");
