...
public class FormDefMapping extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.est.model.flow.FormDef formDef;
	...
	public void setProDefinition(
			com.htsoft.est.model.flow.ProDefinition in_proDefinition) {
		this.proDefinition = in_proDefinition;
	}

	public com.htsoft.est.model.flow.FormDef getFormDef() {
		return formDef;
	}

	public void setFormDef(com.htsoft.est.model.flow.FormDef in_formDef) {
	...
	public void setFormDefId(Long aValue) {
		if (aValue == null) {
			...
			formDef = new com.htsoft.est.model.flow.FormDef(aValue);
