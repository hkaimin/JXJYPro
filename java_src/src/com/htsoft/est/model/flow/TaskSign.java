...
public class TaskSign extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.est.model.flow.ProUserAssign proUserAssign;
	...
	public com.htsoft.est.model.flow.ProUserAssign getProUserAssign() {
		return proUserAssign;
	}

	public void setProUserAssign(
			com.htsoft.est.model.flow.ProUserAssign in_proUserAssign) {
	...
	public void setAssignId(Long aValue) {
		if (aValue == null) {
			...
			proUserAssign = new com.htsoft.est.model.flow.ProUserAssign(aValue);
