...
public class FieldRights extends com.htsoft.core.model.BaseModel {
	...
	transient protected com.htsoft.est.model.flow.FormField formField;

	// protected com.htsoft.est.model.flow.FormDefMapping formDefMapping;
	...
	public com.htsoft.est.model.flow.FormField getFormField() {
		return formField;
	}

	public void setFormField(com.htsoft.est.model.flow.FormField in_formField) {
		this.formField = in_formField;
	}

	// public com.htsoft.est.model.flow.FormDefMapping getFormDefMapping () {
	// return formDefMapping;
	// }
	//	
	// public void setFormDefMapping (com.htsoft.est.model.flow.FormDefMapping
	// in_formDefMapping) {
	...
	// formDefMapping = new com.htsoft.est.model.flow.FormDefMapping(aValue);
	...
	public void setFieldId(Long aValue) {
		if (aValue == null) {
			...
			formField = new com.htsoft.est.model.flow.FormField(aValue);
