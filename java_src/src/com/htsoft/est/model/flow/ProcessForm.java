...
public class ProcessForm extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.est.model.flow.ProcessRun processRun;
	...
	public com.htsoft.est.model.flow.ProcessRun getProcessRun () {
		return processRun;
	}	
	
	public void setProcessRun (com.htsoft.est.model.flow.ProcessRun in_processRun) {
...
//	}
	...
	public void setRunId(Long aValue) {
	    if (aValue==null) {
	        ...
	        processRun = new com.htsoft.est.model.flow.ProcessRun(aValue);
