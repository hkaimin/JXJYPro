package com.htsoft.est.model.flow;
/*
...
public class ProDefRights extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.est.model.flow.ProDefinition proDefinition;
	protected com.htsoft.est.model.system.GlobalType globalType;
	...
	public com.htsoft.est.model.flow.ProDefinition getProDefinition () {
		return proDefinition;
	}	
	
	public void setProDefinition (com.htsoft.est.model.flow.ProDefinition in_proDefinition) {
		this.proDefinition = in_proDefinition;
	}
	
	public com.htsoft.est.model.system.GlobalType getGlobalType () {
		return globalType;
	}	
	
	public void setGlobalType (com.htsoft.est.model.system.GlobalType in_globalType) {
	...
	public void setProTypeId(Long aValue) {
	    if (aValue==null) {
	        ...
	        globalType = new com.htsoft.est.model.system.GlobalType(aValue);
	...
	public void setDefId(Long aValue) {
	    if (aValue==null) {
	        ...
	        proDefinition = new com.htsoft.est.model.flow.ProDefinition(aValue);
