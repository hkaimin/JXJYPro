...
public class FormField extends com.htsoft.core.model.BaseModel {
	...
	transient protected com.htsoft.est.model.flow.FormTable formTable;
	@Expose
	...
	public com.htsoft.est.model.flow.FormTable getFormTable () {
		return formTable;
	}	
	
	public void setFormTable (com.htsoft.est.model.flow.FormTable in_formTable) {
	...
	public void setTableId(Long aValue) {
	    if (aValue==null) {
	        ...
	        formTable = new com.htsoft.est.model.flow.FormTable(aValue);
