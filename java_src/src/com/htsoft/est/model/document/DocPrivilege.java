package com.htsoft.est.model.document;
/*
...
public class DocPrivilege extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.est.model.document.Document document;
	protected com.htsoft.est.model.document.DocFolder docFolder;
	...
	public com.htsoft.est.model.document.Document getDocument () {
		return document;
	}	
	
	public void setDocument (com.htsoft.est.model.document.Document in_document) {
		this.document = in_document;
	}
	
	public com.htsoft.est.model.document.DocFolder getDocFolder () {
		return docFolder;
	}	
	
	public void setDocFolder (com.htsoft.est.model.document.DocFolder in_docFolder) {
	...
	public void setFolderId(Long aValue) {
	    if (aValue==null) {
	        ...
	        docFolder = new com.htsoft.est.model.document.DocFolder(aValue);
	...
	public void setDocId(Long aValue) {
	    if (aValue==null) {
	        ...
	        document = new com.htsoft.est.model.document.Document(aValue);
