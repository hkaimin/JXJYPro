...
public class UserSub extends com.htsoft.core.model.BaseModel {
	...
	@Expose
	protected com.htsoft.est.model.system.AppUser subAppUser;
	@Expose
	protected java.lang.Long userId;
//	protected com.htsoft.est.model.system.AppUser appUser; //下属
...
//	}
//
//	public void setAppUser(com.htsoft.est.model.system.AppUser appUser) {
//		this.appUser = appUser;
//	}
	
	
	
	public com.htsoft.est.model.system.AppUser getSubAppUser() {
		return subAppUser;
	}

	public void setSubAppUser(com.htsoft.est.model.system.AppUser subAppUser) {
	...
	public void setSubUserId(Long aValue) {
	    if (aValue==null) {
	    	...
	    	subAppUser = new com.htsoft.est.model.system.AppUser(aValue);
