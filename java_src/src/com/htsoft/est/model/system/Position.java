...
public class Position extends com.htsoft.core.model.BaseModel {
	...
	transient protected java.util.Set positionSubs = new java.util.HashSet();
	...
	public java.util.Set getPositionSubs () {
		return positionSubs;
	}	
	
	public void setPositionSubs (java.util.Set in_positionSubs) {
		this.positionSubs = in_positionSubs;
	}
