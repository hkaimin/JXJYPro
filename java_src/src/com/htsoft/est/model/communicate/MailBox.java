package com.htsoft.est.model.communicate;
/*
...
public class MailBox extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.est.model.communicate.Mail mail;
	protected com.htsoft.est.model.system.AppUser appUser;
	protected com.htsoft.est.model.communicate.MailFolder mailFolder;
	...
	public com.htsoft.est.model.communicate.Mail getMail(){
		return mail;
	}	
	
	public void setMail (com.htsoft.est.model.communicate.Mail in_mail) {
		this.mail = in_mail;
	}
	
	public com.htsoft.est.model.system.AppUser getAppUser () {
		return appUser;
	}	
	
	public void setAppUser (com.htsoft.est.model.system.AppUser in_appUser) {
		this.appUser = in_appUser;
	}
	
	public com.htsoft.est.model.communicate.MailFolder getMailFolder () {
		return mailFolder;
	}	
	
	public void setMailFolder (com.htsoft.est.model.communicate.MailFolder in_mailFolder) {
	...
	public void setMailId(Long aValue) {
	    if (aValue==null) {
	        ...
	        mail = new com.htsoft.est.model.communicate.Mail(aValue);
	...
	public void setFolderId(Long aValue) {
	    if (aValue==null) {
	        ...
	        mailFolder = new com.htsoft.est.model.communicate.MailFolder(aValue);
	...
	public void setUserId(Long aValue) {
	    if (aValue==null) {
	        ...
	        appUser = new com.htsoft.est.model.system.AppUser(aValue);
