...
public class OutMail extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.est.model.communicate.OutMailFolder outMailFolder;
	...
	public com.htsoft.est.model.communicate.OutMailFolder getOutMailFolder () {
		return outMailFolder;
	}	
	
	public void setOutMailFolder (com.htsoft.est.model.communicate.OutMailFolder in_outMailFolder) {
	...
	public void setFolderId(Long aValue) {
	    if (aValue==null) {
	        ...
	        outMailFolder = new com.htsoft.est.model.communicate.OutMailFolder(aValue);
