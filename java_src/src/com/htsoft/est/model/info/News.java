...
public class News extends com.htsoft.core.model.BaseModel {
	...
	@Expose
	protected com.htsoft.est.model.info.Section section;
	@Expose
	...
	public com.htsoft.est.model.info.Section getSection () {
		return section;
	}	
	
	public void setSection (com.htsoft.est.model.info.Section in_section) {
	...
	public void setSectionId(Long aValue) {
	    if (aValue==null) {
	        ...
	        section = new com.htsoft.est.model.info.Section(aValue);
