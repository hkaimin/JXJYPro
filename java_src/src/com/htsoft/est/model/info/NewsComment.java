package com.htsoft.est.model.info;
/*
...
public class NewsComment extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.est.model.info.News news;
	...
	public com.htsoft.est.model.info.News getNews () {
		return news;
	}	
	
	public void setNews (com.htsoft.est.model.info.News in_news) {
		this.news = in_news;
	}
	...
	public void setNewsId(Long aValue) {
	    if (aValue==null) {
	        ...
	        news = new com.htsoft.est.model.info.News(aValue);
