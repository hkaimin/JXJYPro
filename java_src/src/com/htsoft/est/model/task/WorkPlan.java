...
//    @Expose
//	protected com.htsoft.est.model.task.PlanType planType;
    @Expose
...
//	public com.htsoft.est.model.task.PlanType getPlanType () {
//		return planType;
//	}	
//	
//	public void setPlanType (com.htsoft.est.model.task.PlanType in_planType) {
...
//	        planType = new com.htsoft.est.model.task.PlanType(aValue);
...
//	}	
	...
	public void setProTypeId(Long typeId) {
		if(typeId==null){
			...
			globalType=new com.htsoft.est.model.system.GlobalType(typeId);
