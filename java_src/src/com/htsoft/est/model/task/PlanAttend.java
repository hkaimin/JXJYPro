package com.htsoft.est.model.task;
/*
...
public class PlanAttend extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.est.model.task.WorkPlan workPlan;
	protected com.htsoft.est.model.system.Department department;
	...
	public com.htsoft.est.model.task.WorkPlan getWorkPlan () {
		return workPlan;
	}	
	
	public void setWorkPlan (com.htsoft.est.model.task.WorkPlan in_workPlan) {
		this.workPlan = in_workPlan;
	}
	
	public com.htsoft.est.model.system.Department getDepartment () {
		return department;
	}	
	
	public void setDepartment (com.htsoft.est.model.system.Department in_department) {
	...
	public void setDepId(Long aValue) {
	    if (aValue==null) {
	        ...
	        department = new com.htsoft.est.model.system.Department(aValue);
	...
	public void setPlanId(Long aValue) {
	    if (aValue==null) {
	        ...
	        workPlan = new com.htsoft.est.model.task.WorkPlan(aValue);
